...
const ProductTabsSection = () => {
  ...
  const products = [
    ...
    { id: 2, title: 'Product 2', price: 69.99, description: 'Another description.', image: 'assets/products/product-1.jpg', sizes: ['400gm', '800gm'] },
    { id: 3, title: 'Product 3', price: 79.99, description: 'Third description.', image: 'assets/products/product-1.jpg', sizes: ['400gm', '800gm'] },
    { id: 4, title: 'Product 4', price: 89.99, description: 'Fourth description.', image: 'assets/products/product-1.jpg', sizes: ['400gm', '800gm'] },
    { id: 5, title: 'Product 5', price: 99.99, description: 'Fifth description.', image: 'assets/products/product-1.jpg', sizes: ['400gm', '800gm'] },
    { id: 6, title: 'Product 6', price: 109.99, description: 'Sixth description.', image: 'assets/products/product-1.jpg', sizes: ['400gm', '800gm'] },
    { id: 7, title: 'Product 7', price: 119.99, description: 'Seventh description.', image: 'assets/products/product-1.jpg', sizes: ['400gm', '800gm'] },
    { id: 8, title: 'Product 8', price: 129.99, description: 'Eighth description.', image: 'assets/products/product-1.jpg', sizes: ['400gm', '800gm'] },
    { id: 9, title: 'Product 9', price: 139.99, description: 'Ninth description.', image: 'assets/products/product-1.jpg', sizes: ['400gm', '800gm'] },
